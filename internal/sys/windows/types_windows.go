...
const (
	// GetSystemMetrics() codes as per https://learn.microsoft.com/en-us/windows/win32/api/winuser/nf-winuser-getsystemmetrics 4/21/2024
	...
	SM_CYCURSOR             = 14     // The nominal height of a cursor, in pixels.
	...
	SM_CYICON               = 12     // The system large height of an icon, in pixels. The LoadIcon function can load only icons with the dimensions that SM_CXICON and SM_CYICON specifies. See Icon Sizes for more info.
	...
	SM_SERVERR                     = 289    // The build number if the system is Windows Server 2003 R2; otherwise, 0.
